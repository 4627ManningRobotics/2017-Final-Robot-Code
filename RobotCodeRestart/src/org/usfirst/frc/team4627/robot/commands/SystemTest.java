...
public class SystemTest extends CommandGroup {
    ...
    public  SystemTest() {
    	...
    	System.out.println("Turning to 30 degrees");
    	addSequential(new AutoTurn(30));
    	System.out.println("Turning to -60 degrees");
    	addSequential(new AutoTurn(-60));
    	System.out.println("Turning back to 30 degrees");
    	addSequential(new AutoTurn(30));
    	System.out.println("Spit that out");
    	addSequential(new SetShootSpeed(1));
    	addSequential(new Wait(1));
    	System.out.println("Suck that in");
    	addSequential(new SetShootSpeed(-1));
    	addSequential(new Wait(1));
    	...
    	addSequential(new ShiftLow());
    	System.out.println("All completed successfully! DREW SMASH");
